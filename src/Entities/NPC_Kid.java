...
public class NPC_Kid extends Entity{
    // IDLE ANIMATION:
        ...
        public NPC_Kid(GamePanel gamePanel) {
            super(gamePanel);
            direction = "left";
            speed = 1;
            getImage();
    ...
    public void getImage(){
        down1 = setup("NPC_Kid/down_1");
        down2 = setup("NPC_Kid/down_2");
        down3 = setup("NPC_Kid/down_3");

        left1 = setup("NPC_Kid/left_1");
        left2 = setup("NPC_Kid/left_2");
        left3 = setup("NPC_Kid/left_3");

        right1 = setup("NPC_Kid/right_1");
        right2 = setup("NPC_Kid/right_2");
        right3 = setup("NPC_Kid/right_3");

        up1 = setup("NPC_Kid/up_1");
        up2 = setup("NPC_Kid/up_2");
        up3 = setup("NPC_Kid/up_3");
    }
