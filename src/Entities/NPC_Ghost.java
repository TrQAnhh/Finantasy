...
public class NPC_Ghost extends Entity{
    ...
    public NPC_Ghost(GamePanel gamePanel) {
        super(gamePanel);
        direction = "left";
        speed = 1;
        getImage();
    ...
    public void getImage(){
        down1 = setup("NPC_Ghost/down_1");
        down2 = setup("NPC_Ghost/down_2");
        down3 = setup("NPC_Ghost/down_3");

        left1 = setup("NPC_Ghost/left_1");
        left2 = setup("NPC_Ghost/left_2");
        left3 = setup("NPC_Ghost/left_3");

        right1 = setup("NPC_Ghost/right_1");
        right2 = setup("NPC_Ghost/right_2");
        right3 = setup("NPC_Ghost/right_3");

        up1 = setup("NPC_Ghost/up_1");
        up2 = setup("NPC_Ghost/up_2");
        up3 = setup("NPC_Ghost/up_3");
